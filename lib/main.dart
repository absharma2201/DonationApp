...
class MyApp extends StatelessWidget {
  const MyApp({Key key, this.authServiceBuilder, this.databaseBuilder, this.storageBuilder})
      : super(key: key);
  // Expose builders for 3rd party services at the root of the widget tree
  // This is useful when mocking services while testing
  final FirebaseAuthService Function(BuildContext context) authServiceBuilder;
  final FirestoreDatabase Function(BuildContext context, String uid) databaseBuilder;
  final StorageService Function(BuildContext context, String uid) storageBuilder;
    ...
    return MultiProvider(
      ...
      child: AuthWidgetBuilder(
        ...
        builder: (context, userSnapshot) {
          return MaterialApp(
            theme: ThemeData(
              scaffoldBackgroundColor: Color(0xFF2d3447),//Color(0xffE5E5E5),//Color(0xFFFFFFFF),
